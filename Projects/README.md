...
## Table of Contents
 ...
 2.[Create two S3 buckets, Upload files in one bucket, Use CLI to copy from that bucket to the other](./2.AWS-CLI-S3.md)

 3.[Packing up & Restoring EC2 Servers](./3.Packing-Up-and-Restoring-EC2-Servers.md)
